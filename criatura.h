...
public:
    ...
    Eva(string nom, Piloto* pilot):Criatura(nom, 2000 + rand()%(4001 - 2000)), pil(pilot), armas{"punios", "---", "---"},conector(true),carga(100),sincronizacion(100) {};
